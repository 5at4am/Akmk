...
const Navbar = () => {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 mx-auto w-full max-w-screen-lg border border-gray-100 bg-white/80 py-3 shadow backdrop-blur-lg md:top-6 md:rounded-3xl">
      <div className="px-4">
